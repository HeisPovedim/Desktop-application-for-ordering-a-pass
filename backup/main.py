...
class MainWindow(QMainWindow):
  ...
  def individual_visit_window(self):
    ...
    receivingParty_FIO.setValidator(QRegularExpressionValidator(QRegularExpression("^[а-яА-Я\\s]*$")))
    ...
    receivingParty_FIO.textEdited.connect(lambda: receivingParty_FIO.setText(capitalize_text(receivingParty_FIO.text())))
